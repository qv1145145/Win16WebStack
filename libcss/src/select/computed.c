...
css_error css__computed_style_create(css_computed_style **result, css_calculator *calc)
{
        ...
        s = css_calloc(1, sizeof(css_computed_style));
        if (s == NULL)
                return CSS_NOMEM;
 ...
 */
css_error LIBCSS_API css_computed_style_destroy(css_computed_style *style)
{
        if (style == NULL)
                return CSS_BADPARM;
        ...
        if (style->counter_increment != NULL) {
                ...
                css_free(style->counter_increment);
        }
 ...
 */
css_error LIBCSS_API css_computed_style_compose(
                ...
                css_computed_style **restrict result)
{
         ...
         *   to avoid the churn of unnecesaraly allocating and css_freeing
...
uint8_t LIBCSS_API css_computed_letter_spacing(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_letter_spacing(style, length, unit);
}

uint8_t LIBCSS_API css_computed_outline_color(const css_computed_style *style,
                css_color *color)
{
        return get_outline_color(style, color);
}

uint8_t LIBCSS_API css_computed_outline_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
...
uint8_t LIBCSS_API css_computed_border_spacing(const css_computed_style *style,
...
uint8_t LIBCSS_API css_computed_word_spacing(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_word_spacing(style, length, unit);
}

uint8_t LIBCSS_API css_computed_writing_mode(const css_computed_style *style)
{
        return get_writing_mode(style);
}

uint8_t LIBCSS_API css_computed_counter_increment(const css_computed_style *style,
                const css_computed_counter **counters)
{
        return get_counter_increment(style, counters);
}

uint8_t LIBCSS_API css_computed_counter_reset(const css_computed_style *style,
                const css_computed_counter **counters)
{
        return get_counter_reset(style, counters);
}

uint8_t LIBCSS_API css_computed_cursor(const css_computed_style *style,
                lwc_string ***urls)
{
        return get_cursor(style, urls);
}

uint8_t LIBCSS_API css_computed_clip(const css_computed_style *style,
                css_computed_clip_rect *rect)
{
        return get_clip(style, rect);
}

uint8_t LIBCSS_API css_computed_content(const css_computed_style *style,
                const css_computed_content_item **content)
{
        return get_content(style, content);
}

uint8_t LIBCSS_API css_computed_vertical_align(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_vertical_align(style, length, unit);
}

uint8_t LIBCSS_API css_computed_font_size(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_font_size(style, length, unit);
}

uint8_t LIBCSS_API css_computed_border_top_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_border_top_width(style, length, unit);
}

uint8_t LIBCSS_API css_computed_border_right_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_border_right_width(style, length, unit);
}

uint8_t LIBCSS_API css_computed_border_bottom_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_border_bottom_width(style, length, unit);
}

uint8_t LIBCSS_API css_computed_border_left_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_border_left_width(style, length, unit);
}

uint8_t LIBCSS_API css_computed_background_image(const css_computed_style *style,
                lwc_string **url)
{
        return get_background_image(style, url);
}

uint8_t LIBCSS_API css_computed_color(const css_computed_style *style,
                css_color *color)
{
        return get_color(style, color);
}

uint8_t LIBCSS_API css_computed_list_style_image(const css_computed_style *style,
                lwc_string **url)
{
        return get_list_style_image(style, url);
}

uint8_t LIBCSS_API css_computed_quotes(const css_computed_style *style,
                lwc_string ***quotes)
{
        return get_quotes(style, quotes);
}

uint8_t LIBCSS_API css_computed_top(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
...
uint8_t LIBCSS_API css_computed_right(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        uint8_t position = css_computed_position(style);
...
uint8_t LIBCSS_API css_computed_bottom(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        uint8_t position = css_computed_position(style);
...
uint8_t LIBCSS_API css_computed_left(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        uint8_t position = css_computed_position(style);
...
uint8_t LIBCSS_API css_computed_border_top_color(const css_computed_style *style,
                css_color *color)
{
        return get_border_top_color(style, color);
}

uint8_t LIBCSS_API css_computed_border_right_color(const css_computed_style *style,
                css_color *color)
{
        return get_border_right_color(style, color);
}

uint8_t LIBCSS_API css_computed_border_bottom_color(const css_computed_style *style,
                css_color *color)
{
        return get_border_bottom_color(style, color);
}

uint8_t LIBCSS_API css_computed_border_left_color(const css_computed_style *style,
                css_color *color)
{
        return get_border_left_color(style, color);
}

uint8_t LIBCSS_API css_computed_box_sizing(const css_computed_style *style)
{
        return get_box_sizing(style);
}

uint8_t LIBCSS_API css_computed_height(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_height(style, length, unit);
}

uint8_t LIBCSS_API css_computed_line_height(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_line_height(style, length, unit);
}

uint8_t LIBCSS_API css_computed_background_color(const css_computed_style *style,
                css_color *color)
{
        return get_background_color(style, color);
}

uint8_t LIBCSS_API css_computed_z_index(const css_computed_style *style,
                int32_t *z_index)
{
        return get_z_index(style, z_index);
}

uint8_t LIBCSS_API css_computed_margin_top(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_margin_top(style, length, unit);
}

uint8_t LIBCSS_API css_computed_margin_right(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_margin_right(style, length, unit);
}

uint8_t LIBCSS_API css_computed_margin_bottom(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_margin_bottom(style, length, unit);
}

uint8_t LIBCSS_API css_computed_margin_left(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_margin_left(style, length, unit);
}

uint8_t LIBCSS_API css_computed_background_attachment(const css_computed_style *style)
{
        return get_background_attachment(style);
}

uint8_t LIBCSS_API css_computed_border_collapse(const css_computed_style *style)
{
        return get_border_collapse(style);
}

uint8_t LIBCSS_API css_computed_caption_side(const css_computed_style *style)
{
        return get_caption_side(style);
}

uint8_t LIBCSS_API css_computed_direction(const css_computed_style *style)
{
        return get_direction(style);
}

uint8_t LIBCSS_API css_computed_max_height(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_max_height(style, length, unit);
}

uint8_t LIBCSS_API css_computed_max_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_max_width(style, length, unit);
}

uint8_t LIBCSS_API css_computed_width_px(
...
uint8_t LIBCSS_API css_computed_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
...
uint8_t LIBCSS_API css_computed_empty_cells(const css_computed_style *style)
{
        return get_empty_cells(style);
}

uint8_t LIBCSS_API css_computed_float(const css_computed_style *style)
{
        uint8_t position = css_computed_position(style);
...
uint8_t LIBCSS_API css_computed_font_style(const css_computed_style *style)
{
        return get_font_style(style);
}

uint8_t LIBCSS_API css_computed_min_height(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
...
uint8_t LIBCSS_API css_computed_min_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
...
uint8_t LIBCSS_API css_computed_background_repeat(const css_computed_style *style)
{
        return get_background_repeat(style);
}

uint8_t LIBCSS_API css_computed_clear(const css_computed_style *style)
{
        return get_clear(style);
}

uint8_t LIBCSS_API css_computed_padding_top(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_padding_top(style, length, unit);
}

uint8_t LIBCSS_API css_computed_padding_right(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_padding_right(style, length, unit);
}

uint8_t LIBCSS_API css_computed_padding_bottom(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_padding_bottom(style, length, unit);
}

uint8_t LIBCSS_API css_computed_padding_left(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_padding_left(style, length, unit);
}

uint8_t LIBCSS_API css_computed_overflow_x(const css_computed_style *style)
{
        return get_overflow_x(style);
}

uint8_t LIBCSS_API css_computed_overflow_y(const css_computed_style *style)
{
        return get_overflow_y(style);
}

uint8_t LIBCSS_API css_computed_position(const css_computed_style *style)
{
        return get_position(style);
}

uint8_t LIBCSS_API css_computed_opacity(const css_computed_style *style,
                css_fixed *opacity)
{
        return get_opacity(style, opacity);
}

uint8_t LIBCSS_API css_computed_fill_opacity(const css_computed_style *style,
                css_fixed *fill_opacity)
{
        return get_fill_opacity(style, fill_opacity);
}

uint8_t LIBCSS_API css_computed_stroke_opacity(const css_computed_style *style,
                css_fixed *stroke_opacity)
{
        return get_stroke_opacity(style, stroke_opacity);
}

uint8_t LIBCSS_API css_computed_text_transform(const css_computed_style *style)
{
        return get_text_transform(style);
}

uint8_t LIBCSS_API css_computed_text_indent(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_text_indent(style, length, unit);
}

uint8_t LIBCSS_API css_computed_white_space(const css_computed_style *style)
{
        return get_white_space(style);
}

uint8_t LIBCSS_API css_computed_background_position(const css_computed_style *style,
                css_fixed *hlength, css_unit *hunit,
                css_fixed *vlength, css_unit *vunit)
{
...
uint8_t LIBCSS_API css_computed_break_after(const css_computed_style *style)
{
        return get_break_after(style);
}

uint8_t LIBCSS_API css_computed_break_before(const css_computed_style *style)
{
        return get_break_before(style);
}

uint8_t LIBCSS_API css_computed_break_inside(const css_computed_style *style)
{
        return get_break_inside(style);
}

uint8_t LIBCSS_API css_computed_column_count(const css_computed_style *style,
                int32_t *column_count)
{
        return get_column_count(style, column_count);
}

uint8_t LIBCSS_API css_computed_column_fill(const css_computed_style *style)
{
        return get_column_fill(style);
}

uint8_t LIBCSS_API css_computed_column_gap(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_column_gap(style, length, unit);
}

uint8_t LIBCSS_API css_computed_column_rule_color(const css_computed_style *style,
                css_color *color)
{
        /* This property is in the uncommon block, so we need to handle
...
uint8_t LIBCSS_API css_computed_column_rule_style(const css_computed_style *style)
{
        return get_column_rule_style(style);
}

uint8_t LIBCSS_API css_computed_column_rule_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        /* This property is in the uncommon block, so we need to handle
         * absolute value calculation for initial value (medium) here. */
...
uint8_t LIBCSS_API css_computed_column_span(const css_computed_style *style)
{
        return get_column_span(style);
}

uint8_t LIBCSS_API css_computed_column_width(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_column_width(style, length, unit);
}

uint8_t LIBCSS_API css_computed_display(const css_computed_style *style,
                bool root)
{
        uint8_t position = css_computed_position(style);
        uint8_t display = get_display(style);
...
uint8_t LIBCSS_API css_computed_display_static(const css_computed_style *style)
{
        return get_display(style);
}

uint8_t LIBCSS_API css_computed_font_variant(const css_computed_style *style)
{
        return get_font_variant(style);
}

uint8_t LIBCSS_API css_computed_text_decoration(const css_computed_style *style)
{
        return get_text_decoration(style);
}

uint8_t LIBCSS_API css_computed_font_family(const css_computed_style *style,
                lwc_string ***names)
{
        return get_font_family(style, names);
}

uint8_t LIBCSS_API css_computed_border_top_style(const css_computed_style *style)
{
        return get_border_top_style(style);
}

uint8_t LIBCSS_API css_computed_border_right_style(const css_computed_style *style)
{
        return get_border_right_style(style);
}

uint8_t LIBCSS_API css_computed_border_bottom_style(const css_computed_style *style)
{
        return get_border_bottom_style(style);
}

uint8_t LIBCSS_API css_computed_border_left_style(const css_computed_style *style)
{
        return get_border_left_style(style);
}

uint8_t LIBCSS_API css_computed_font_weight(const css_computed_style *style)
{
        return get_font_weight(style);
}

uint8_t LIBCSS_API css_computed_list_style_type(const css_computed_style *style)
{
        return get_list_style_type(style);
}

uint8_t LIBCSS_API css_computed_outline_style(const css_computed_style *style)
{
        return get_outline_style(style);
}

uint8_t LIBCSS_API css_computed_table_layout(const css_computed_style *style)
{
        return get_table_layout(style);
}

uint8_t LIBCSS_API css_computed_unicode_bidi(const css_computed_style *style)
{
        return get_unicode_bidi(style);
}

uint8_t LIBCSS_API css_computed_visibility(const css_computed_style *style)
{
        return get_visibility(style);
}

uint8_t LIBCSS_API css_computed_list_style_position(const css_computed_style *style)
{
        return get_list_style_position(style);
}

uint8_t LIBCSS_API css_computed_text_align(const css_computed_style *style)
{
        return get_text_align(style);
}

uint8_t LIBCSS_API css_computed_page_break_after(const css_computed_style *style)
{
        return get_page_break_after(style);
}

uint8_t LIBCSS_API css_computed_page_break_before(const css_computed_style *style)
{
        return get_page_break_before(style);
}

uint8_t LIBCSS_API css_computed_page_break_inside(const css_computed_style *style)
{
        return get_page_break_inside(style);
}

uint8_t LIBCSS_API css_computed_orphans(const css_computed_style *style,
                int32_t *orphans)
{
        return get_orphans(style, orphans);
}

uint8_t LIBCSS_API css_computed_widows(const css_computed_style *style,
                int32_t *widows)
{
        return get_widows(style, widows);
}

uint8_t LIBCSS_API css_computed_align_content(const css_computed_style *style)
{
        return get_align_content(style);
}

uint8_t LIBCSS_API css_computed_align_items(const css_computed_style *style)
{
        return get_align_items(style);
}

uint8_t LIBCSS_API css_computed_align_self(const css_computed_style *style)
{
        return get_align_self(style);
}

uint8_t LIBCSS_API css_computed_flex_basis(const css_computed_style *style,
                css_fixed *length, css_unit *unit)
{
        return get_flex_basis(style, length, unit);
}

uint8_t LIBCSS_API css_computed_flex_direction(const css_computed_style *style)
{
        return get_flex_direction(style);
}

uint8_t LIBCSS_API css_computed_flex_grow(const css_computed_style *style,
                css_fixed *number)
{
        return get_flex_grow(style, number);
}

uint8_t LIBCSS_API css_computed_flex_shrink(const css_computed_style *style,
                css_fixed *number)
{
        return get_flex_shrink(style, number);
}

uint8_t LIBCSS_API css_computed_flex_wrap(const css_computed_style *style)
{
        return get_flex_wrap(style);
}

uint8_t LIBCSS_API css_computed_justify_content(const css_computed_style *style)
{
        return get_justify_content(style);
}

uint8_t LIBCSS_API css_computed_order(const css_computed_style *style,
                int32_t *order)
{
