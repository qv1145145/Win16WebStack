...
css_error css__font_face_create(css_font_face **result)
{
        ...
        f = css_malloc(sizeof(css_font_face));
        if (f == NULL)
                return CSS_NOMEM;
 ...
 *         CSS_BADPARM on bad parameters.
 */
css_error LIBCSS_API css_font_face_get_font_family(const css_font_face *font_face,
                lwc_string **font_family)
{
        if (font_face == NULL || font_family == NULL)
                return CSS_BADPARM;
 ...
 */
uint8_t LIBCSS_API css_font_face_font_style(const css_font_face *font_face)
{
 ...
 */
uint8_t LIBCSS_API css_font_face_font_weight(const css_font_face *font_face)
{
 ...
 *         CSS_BADPARM on bad parameters.
 */
css_error LIBCSS_API css_font_face_count_srcs(const css_font_face *font_face,
                uint32_t *count)
{
 ...
 *         CSS_BADPARM on bad parameters.
 */
css_error LIBCSS_API css_font_face_get_src(const css_font_face *font_face,
 ...
 *        from LIBCSS_API css_font_face_src_format.
 */
css_error LIBCSS_API css_font_face_src_get_location(const css_font_face_src *src,
                lwc_string **location)
{
 ...
 */
css_font_face_location_type LIBCSS_API css_font_face_src_location_type(
 ...
 */
css_font_face_format LIBCSS_API css_font_face_src_format(const css_font_face_src *src)
{
