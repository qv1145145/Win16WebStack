...
parserutils_error PARSERUTILS_API parserutils_inputstream_create(const char *enc,
                uint32_t encsrc, parserutils_charset_detect_func csdetect,
                parserutils_inputstream **stream);
/* Destroy an input stream */
parserutils_error PARSERUTILS_API parserutils_inputstream_destroy(
                parserutils_inputstream *stream);

/* Append data to an input stream */
parserutils_error PARSERUTILS_API parserutils_inputstream_append(
                parserutils_inputstream *stream,
                const uint8_t *data, size_t len);
/* Insert data into stream at current location */
parserutils_error PARSERUTILS_API parserutils_inputstream_insert(
                parserutils_inputstream *stream,
                const uint8_t *data, size_t len);

/* Slow form of css_inputstream_peek. */
parserutils_error PARSERUTILS_API parserutils_inputstream_peek_slow(
                parserutils_inputstream *stream, 
...
const char * PARSERUTILS_API parserutils_inputstream_read_charset(
                parserutils_inputstream *stream, uint32_t *source);
/* Change the document charset */
parserutils_error PARSERUTILS_API parserutils_inputstream_change_charset(
                parserutils_inputstream *stream, 
