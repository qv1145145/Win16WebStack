...
#if defined(_WIN16)
#define WAPCAP_API __far __pascal __export
#else
#define WAPCAP_API
#endif
 ...
 *       on it.
 */
lwc_error WAPCAP_API lwc_intern_string(const char *s, size_t slen,
                                       lwc_string **ret);
 ...
 */
lwc_error WAPCAP_API lwc_intern_substring(lwc_string *str,
 ...
 *             to by \a ret will not be valid.
 */
lwc_error WAPCAP_API lwc_string_tolower(lwc_string *str, lwc_string **ret);
 ...
 * @param str The string to unref.
 */
void WAPCAP_API lwc_string_destroy(lwc_string *str);
 ...
 */
lwc_error WAPCAP_API lwc__intern_caseless_string(lwc_string *str);
 ...
 */
void WAPCAP_API lwc_iterate_strings(lwc_iteration_callback_fn cb, void *pw);
