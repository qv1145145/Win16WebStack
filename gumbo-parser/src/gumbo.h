...
/* Win16 DLL export/import macro */
#ifndef GUMBO_16BIT_API
#  if defined(_WIN16)
#    define GUMBO_16BIT_API __far __pascal __export
#  else
#    define GUMBO_16BIT_API
#  endif
#endif
 ...
 */
extern const GumboSourcePosition __export kGumboEmptySourcePosition;
...
extern const GumboStringPiece __export kGumboEmptyString;

/**
 * Compares two GumboStringPieces, and returns true if they're equal or false
 * otherwise.
 */
bool GUMBO_16BIT_API gumbo_string_equals(
 ...
 */
bool GUMBO_16BIT_API gumbo_string_equals_ignore_case(
    const GumboStringPiece* str1, const GumboStringPiece* str2);
...
extern const GumboVector __export kGumboEmptyVector;

/**
 * Returns the first index at which an element appears in this vector (testing
 * by pointer equality), or -1 if it never does.
 */
int GUMBO_16BIT_API gumbo_vector_index_of(GumboVector* vector, const void* element);
 ...
 * library.
 */
const char* GUMBO_16BIT_API gumbo_normalized_tagname(GumboTag tag);
 ...
 * no-op.
 */
void GUMBO_16BIT_API gumbo_tag_from_original_text(GumboStringPiece* text);
 ...
 * the library.
 */
const char* GUMBO_16BIT_API gumbo_normalize_svg_tagname(const GumboStringPiece* tagname);

/**
 * Converts a tag name string (which may be in upper or mixed case) to a tag
 * enum. The `tag` version expects `tagname` to be NULL-terminated
 */
GumboTag GUMBO_16BIT_API gumbo_tag_enum(const char* tagname);
GumboTag GUMBO_16BIT_API gumbo_tagn_enum(const char* tagname, unsigned int length);
 ...
 */
GumboAttribute* GUMBO_16BIT_API gumbo_get_attribute(const GumboVector* attrs, const char* name);
...
extern const GumboOptions __export kGumboDefaultOptions;
