...
parserutils_error PARSERUTILS_API parserutils_charset_codec_create(const char *charset,
                parserutils_charset_codec **codec);
/* Destroy a charset codec */
parserutils_error PARSERUTILS_API parserutils_charset_codec_destroy(
                parserutils_charset_codec *codec);

/* Configure a charset codec */
parserutils_error PARSERUTILS_API parserutils_charset_codec_setopt(
                parserutils_charset_codec *codec,
...
parserutils_error PARSERUTILS_API parserutils_charset_codec_encode(
                parserutils_charset_codec *codec,
                const uint8_t **source, size_t *sourcelen,
                uint8_t **dest, size_t *destlen);

/* Decode a chunk of data in a codec's charset into UCS-4 */
parserutils_error PARSERUTILS_API parserutils_charset_codec_decode(
                parserutils_charset_codec *codec,
                const uint8_t **source, size_t *sourcelen,
                uint8_t **dest, size_t *destlen);

/* Reset a charset codec */
parserutils_error PARSERUTILS_API parserutils_charset_codec_reset(
                parserutils_charset_codec *codec);
