 ...
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_to_ucs4(const uint8_t *s,
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_from_ucs4(uint32_t ucs4, uint8_t *s,
                size_t *len)
{
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_length(const uint8_t *s, size_t max,
                size_t *len)
{
        const uint16_t *ss = (const uint16_t *) (const void *) s;
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_char_byte_length(const uint8_t *s,
                size_t *len)
{
        const uint16_t *ss = (const uint16_t *) (const void *) s;
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_prev(const uint8_t *s, uint32_t off,
                uint32_t *prevoff)
{
        const uint16_t *ss = (const uint16_t *) (const void *) s;
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_next(const uint8_t *s, uint32_t len,
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_charset_utf16_next_paranoid(const uint8_t *s,
