 ...
 */
parserutils_error PARSERUTILS_API  parserutils_stack_create(size_t item_size, size_t chunk_size,
 ...
 */
parserutils_error PARSERUTILS_API  parserutils_stack_destroy(parserutils_stack *stack)
{
        if (stack == NULL)
                return PARSERUTILS_BADPARM;
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise
 */
parserutils_error PARSERUTILS_API  parserutils_stack_push(parserutils_stack *stack,
                const void *item)
{
        int32_t slot;
 ...
 * \return PARSERUTILS_OK on success, appropriate error otherwise.
 */
parserutils_error PARSERUTILS_API  parserutils_stack_pop(parserutils_stack *stack, void *item)
{
        if (stack == NULL)
                return PARSERUTILS_BADPARM;
 ...
 */
void * PARSERUTILS_API parserutils_stack_get_current(parserutils_stack *stack)
{
